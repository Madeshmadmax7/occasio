...
const Business = ({ imageStates = {}, toggleStar }) => {
  const imageCount = 9;
  const images = Array.from({ length: imageCount }, (_, i) => `/business/img${i + 1}.jpg`);
  ...
  return (
    <div>
      ...
      <div className="amuse-list-container">
        <h1 className="amuse-list-heading">Business Conferences</h1>
